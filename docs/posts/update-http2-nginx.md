...
![full-img](https://static.is26.com/blog/2015/10/http2.jpg)
...
下面说下如何升级到HTTP/2，目前[nginx 1.9.5](http://nginx.org/en/CHANGES)已经实验性地支持HTTP/2了。
...
![full-img](https://static.is26.com/blog/2015/10/http-dev.jpg)

刷新一下你的网页，主域的`Protocol`已经变了成了`h2`，这就意味着已经成功升级到HTTP/2。

或者使用Chrome的网络工具，在地址栏中输入`chrome://net-internals/#http2`

![full-img](https://static.is26.com/blog/2015/10/http2-chrome.jpg)
