...
date: "2017-06-19"
cover: https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06254.JPG
categories:
  - tech
tags:
  - digital
...
![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06194.JPG)

接下来，我们来进入AMPLIFI HD路由器和WIFI信号放大器的实际体验。

我现在居住的是一个上下两层、共70平米的小LOFT。楼下客厅，楼上工作和居住，在不同的地点都有移动上网使用场景。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06301.JPG)
...
![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06355.JPG)

过去我家里使用的主力路由器是网件2013年推出的旗舰型号R6300V2，也曾经使用过价格百元极路由1S和200余元的华为荣耀立方。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06365.JPG)

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06368.JPG)

第一次见到AMPLIFI的时候，倒有点似曾相识，华为荣耀立方也是纯白色的正方体设计，两者来个对比，左边的价格是右边的5倍，对于荣耀立方，我有一句话，不知道该不该讲。LAN口只有百兆你好意思自称千兆(无线)路由？坑呀

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06375.JPG)

同网件R6300V2相比，AMPLIFI的体积的确是小巧了不少。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06358.JPG)
...
![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06407.JPG)

这里就是AMPLIFI HD所处的位置，白色的正方体，放在家里还是挺和谐的，有点苹果范。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06190.JPG)

安装和配置AMPLIFI还是十分简单的，接上USB-C接口的电源后，AMPLIFI前方的屏幕就会点亮。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06215.JPG)

AMPLIFI-HD采用USB-C作为供电接口，也是未来业界的方向，在这里建议产商可以提供稍微长点的电源线，如果插头或者插座距离路由器有点远的话，就比较尴尬了。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06256.JPG)

第一次开机，会进行初始化。这是一块圆形的触摸屏幕，能够通过手机直接触控屏幕，进行简单的操作。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06265.JPG)

开机后，会提示用户下载APP来进行初始化设置。但是不下载APP也没关系，也能通过一个开放的无加密WIFI来进行初始化。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06266.JPG)

初始化的开放WIFI的名称也显示在了屏幕上，名称中就是机器的MAC地址，十分直接，之所以显示物理MAC地址，也是为了方面用户在有多台AMPLIFI HD的时候，方便区分。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06271.JPG)

这时候手机可以搜索到路由器发射的WIFI信号了，无需密码就可以直接连接。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/setting-2.jpg)

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06274.JPG)

初始化可以设备新的WIFI名和密码，注意，进入管理后台的密码也需要配置，默认是跟WIFI密码一样。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06213.JPG)

设置好网络后，路由器会要求给WAN插上网线连接网络。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06226.JPG)

使用附带的网线连接上级路由的LAN口和AMPLIFI HD的WAN口，WAN口上面有蓝色地球的logo。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06211.JPG)

UBNT在iOS和Android平台上面都推出了一款AmpliFi的APP，两个平台的APP操作和体验基本保持了一致，切换使用没有学习成本。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/setting-1.jpg)

进入APP后，初次配置，会通过过场动画的形式，指导如何进行配置，还是挺直接明了的。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/setting-4.jpg)

APP采用目前流行的扁平设计，中文支持良好。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06204.JPG)

配置好了之后，手机上就提示网络设置成功啦。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/setting-5.jpg)

APP的配置选项还是挺丰富的，点击设备图标，就能分别设置不同的设备。可以在APP里面调节路由器的屏幕亮度和呼吸灯亮度，第一次调节还是挺好玩的。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06290.JPG)

为了防止灯光干扰，还能设置路由器呼吸灯和屏幕的时间，如果路由器是放置在卧室，可以在睡眠时间段关闭灯光。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/amplifi-1.gif)

APP调节屏幕亮度，很有科技感，由于GIF图片压缩问题有点卡顿，实际很流畅。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/amplifi-5.gif)

底部的呼吸灯也能线性调节。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-ALL-1.jpg)

点击屏幕，可以切换显示不同的信息，时间、端口使用情况和连接设备数量、当前设备IP信息、实时网速、总流量等等。一般我都会调节到实时网速，挺带感的。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06341.JPG)

我把WIFI放大器放到了LOFT二楼的墙上，与楼下AMPLIFI HD主路由隔了一个楼板。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06383.JPG)

WIFI放大器的信号灯会随着信号强弱而变化。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06387.JPG)

上次开箱没注意到WIFI放大器的重置孔，浅灰色的小字，不注意看还挺隐蔽的。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06390.JPG)

WIFI信号放大器磁性的转接头。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06391.JPG)

WIFI信号放大器电源插座的磁性接孔。用微距镜头拍几张，补充下上次开箱的细节。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06279.JPG)
...
![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06277.JPG)

近距离下的屏幕细节，非视网膜屏，清晰度一般，但是AMPLIFI主要就是显示网络相关信息，也不会拿来看照片什么的，从成本的角度考虑，也足够了。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06287.JPG)

WIFI信号放大器加入网络后，在APP里面也会有WIFI信号放大器的配置。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/setting-6.jpg)

相比路由器而言，WIFI信号放大器的配置就少了点。

![](https://c2.llyz.xyz/blog/2017/06/amplifi/setting-7.jpg)
...
![](https://c2.llyz.xyz/blog/2017/06/amplifi/ios-all.jpg)
...
![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06318.JPG)
...
![](https://c2.llyz.xyz/blog/2017/06/amplifi/speed-1.jpg)
...
![](https://c2.llyz.xyz/blog/2017/06/amplifi/speed-01.jpg)

下面Macbook通过USB0-C千兆网卡转接头连接AMPLIFI路由器，再看下传输速度。系统显示是1000 Mb/s的链接速度，千兆网络正确识别。

## 信号

![](https://c2.llyz.xyz/blog/2017/06/amplifi/AMPLIFI-06351.JPG)

最后再来看下AMPLIFI HD的信号衰减情况。这里我主要使用的是Macbook上面的Wifi Explorer来分析WIFI信号强度。

#### 距离0米

![](https://c2.llyz.xyz/blog/2017/06/amplifi/wifi-0.jpg)

由于Macbook就在路由器旁边，此时信号强度100%，信号极佳，从WIFI扫描列表中，也可以看到我所在的环境WIFI很多，2.4Ghz频道信道十分拥堵。相比而言5G的信道更加稳定。

#### 距离5米

![](https://c2.llyz.xyz/blog/2017/06/amplifi/wifi-5m.jpg)

Macbook距离路由器5米，中间无间隔，此时信号强度88%，十分稳定。

#### 隔了一层楼板

![](https://c2.llyz.xyz/blog/2017/06/amplifi/wifi-5m2.jpg)

接下来我抱着Macbook来到LOFT的二层的办公桌，这里与楼下路由器位置隔了一层架空板。但是距离较近，依旧是5米，这是可以看到信号强度保持在82%，依旧不错。

#### 隔了一堵防盗门

![](https://c2.llyz.xyz/blog/2017/06/amplifi/wifi-door.jpg)
...
![](https://c2.llyz.xyz/blog/2017/06/amplifi/wifi-door2.jpg)
...
![](https://c2.llyz.xyz/blog/2017/06/amplifi/wifi-mesh.jpg)
