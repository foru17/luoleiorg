...
有些人喜欢原生 Chrome，有些人则喜欢安装各种拓展丰富 Chrome 的功能。我算得上是后者，好了，言归正传，下面就说说我目前常用的 Chrome extension，并且直接附上 Chrome Store的 安装地址。
...
修改 HTML、CSS、js文档，自动监测文件变化，chrome自动刷新，双屏办公的时候各种爽，不用按F5刷新了。
